...
extern void handleGetCommand(int sockfd,char* buffer, size_t bufferSize, char* filename);
...
extern int handlePutCommand(struct sockaddr_storage remoteaddr, socklen_t addrlen, char* buf, size_t bufferSize, int sockfd, const  char* filename, const char* verzeichnis);
